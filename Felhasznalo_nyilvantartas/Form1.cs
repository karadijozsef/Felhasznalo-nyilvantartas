...
namespace Felhasznalo_nyilvantartas
{
    public partial class Form1 : Form
    {
        ...
        private bool nincs_adat()
        {
            ...
            {
                MessageBox.Show("Adja meg a profilkép nevét!!!!");
        ...
        private void listBox_felhasznalok_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            felhasznalok kivalasztottfelhasznalo = (felhasznalok)listBox_felhasznalok.SelectedItem;
            textBox_id.Text = kivalasztottfelhasznalo.Id.ToString();
            textBox_nev.Text = kivalasztottfelhasznalo.Nev;
            dateTimePicker_szuletes.Value = kivalasztottfelhasznalo.Szuletesidatum;
            textBox_profilnev.Text = kivalasztottfelhasznalo.Profilnev;
        ...
        private void upload_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                pictureBox_profilkep.Image = Image.FromFile(kepFajl);
            }
        }
    }
}
